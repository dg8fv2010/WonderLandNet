...
int main()
{
	...
	device->getFileSystem()->addZipFileArchive("../../mediatemp/map-20kdm2.pk3");
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("../../mediatemp/particle.bmp"));
	...
	node = smgr->addAnimatedMeshSceneNode(smgr->getMesh("../../mediatemp/faerie.md2"),
	...
	material.setTexture(0, driver->getTexture("../../mediatemp/faerie2.bmp"));
	...
	node = smgr->addAnimatedMeshSceneNode(smgr->getMesh("../../mediatemp/dwarf.x"),
						0, IDFlag_IsPickable | IDFlag_IsHighlightable);
	...
	node = smgr->addAnimatedMeshSceneNode(smgr->getMesh("../../mediatemp/ninja.b3d"),
						0, IDFlag_IsPickable | IDFlag_IsHighlightable);
